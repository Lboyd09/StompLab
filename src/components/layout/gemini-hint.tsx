...
export function GeminiHint() {
  ...
  if (key.trim()) {
    return (
      <p className="text-xs text-muted-foreground">
        New songs use your Gemini Flash-Lite key in this browser. Repeats load from the shared
  ...
  return (
    <p className="text-xs text-muted-foreground">
      ...
      only when you research something new. This app never uses Grok credits.
    </p>
  );
}
