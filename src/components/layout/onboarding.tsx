...
/** First-run lives in Tutorial. This only backfills the onboard flag. */
export function Onboarding({ onFinished }: { onFinished?: () => void }) {
  useLayoutEffect(() => {
    try {
      if (
        (window.localStorage.getItem("stomplab.tutorial.v19") ||
          window.localStorage.getItem("stomplab.tutorial.v18") ||
          window.localStorage.getItem("stomplab.tutorial.v17") ||
          window.localStorage.getItem("stomplab.tutorial.v16") ||
          window.localStorage.getItem("stomplab.tutorial.v15") ||
          window.localStorage.getItem("stomplab.tutorial.v14") ||
          window.localStorage.getItem("stomplab.tutorial.v13") ||
