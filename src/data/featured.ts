...
export const FEATURED: Preset[] = [
  {
    ...
    tempo: 117,
    summary:
      "Nevermind (1991). The missing piece most patches skip is the EHX Small Clone — Butch Vig called it the watery pre-chorus. Path: DS-1 (Stupor OD) → Small Clone (70s Chorus) → Mesa Studio Pre (Cali IV Rhythm 2) → 4×12. Verse = chorus on, quieter amp. Chorus = chorus off, slammed. Solo = chorus back on.",
    originalGear: [
      { role: "Guitar", name: "1969 Fender Mustang (L) / 1965 Jaguar (R)", notes: "Single coils, doubled left/right on the record." },
      { role: "Pedal", name: "BOSS DS-1", notes: "Main Nevermind dirt. Helix has no DS-1 — Stupor OD is the Boss SD-1, same family." },
      { role: "Pedal", name: "EHX Small Clone", notes: "Butch Vig: the chiming/watery guitar on the pre-chorus buildup. Depth switch on. This is the chorus section of the song." },
      { role: "Amp", name: "Mesa/Boogie Studio Preamp + Crown", notes: "Nevermind rack. A Fender Bassman was also blended on some tracks." },
      { role: "Cab", name: "4×12, SM57", notes: "Close, dry. The room is the mix." },
    ],
    recommendedGear: [
    ...
    snapshots: [
      {
        ...
        notes: "DS-1 on, Small Clone ON — the watery verse / pre-chorus. Play lighter; guitar volume ~7.",
        paramOverrides: {
      ...
      },
      {
        ...
        notes: "Small Clone OFF — this is the loud HELLO chorus. Amp slammed, no watery swirl.",
        paramOverrides: {
      ...
      },
      {
        ...
        color: "#f5d000",
        enabledBlocks: ["b1", "b2", "b3", "b4"],
        notes: "Chorus back on for the solo swirl, amp still loud.",
        paramOverrides: {
          b2: { Mix: 4.8, Depth: 6.6 },
          b3: { Drive: 6.6, "Ch Vol": 7.0, Presence: 5.8 },
        },
      },
    ],
    footswitches: [
      { index: 1, label: "VERSE", color: "#7d9a6a", action: "snapshot", snapshotId: "s1", notes: "Quiet verse + Small Clone." },
      { index: 2, label: "CHORUS", color: "#e24a3a", action: "snapshot", snapshotId: "s2", notes: "Loud chorus, clone off." },
      { index: 3, label: "SOLO", color: "#f5d000", action: "snapshot", snapshotId: "s3", notes: "Solo with chorus." },
    ],
    programming: [
      "Snapshot mode (not Stomp mode). FS1 Verse, FS2 Chorus, FS3 Solo.",
      ...
      "70s Chorus is the Small Clone. Rate 3.4, Depth 7.2. ON in Verse and Solo; bypassed in Chorus.",
      "Cali IV Rhythm 2: Snap 1 Drive 4.2 / Ch Vol 5.4. Snap 2 Drive 6.8 / Ch Vol 6.8. Snap 3 Drive 6.6 / Ch Vol 7.0.",
      "Download the .hlx. After import: View menu → Snapshot mode so FS1–FS3 recall the sections.",
    ],
    tips: [
      "The verse should swirl. If it doesn't, you forgot the Small Clone — that is the record.",
      "Play the loud chorus with the guitar wide open and pick near the bridge.",
    ],
  },
  {
    id: "featured-sandman",
  ...
  },
  {
    ...
    programming: [
      ...
      "Command Center: FS8 = Tuner, FS7 = Tap, FS5/6 = dirt/chorus stomps on top of snapshots.",
    ],
    tips: [
  ...
  },
  {
    ...
    programming: [
      ...
      "70s Chorus Rate 3.2 Depth 7.4 Mix 6.2. Do not bypass it — the song disappears.",
    ],
    tips: [
