...
const EMPTY_CWD = mkdtempSync(join(tmpdir(), "grok-og-isolated-"));
...
test("vercel hosts use baked site title and app icons", () => {
  const manifest = JSON.parse(
    renderWebManifest("stomplab.vercel.app", { title: "Stomp Lab", shortName: "StompLab" }),
  );
